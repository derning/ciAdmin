<div class="content-wrap">
	<div id="content">
		...
		<div class="hd-action mb10">       
       	 <button class="btn btn-primary dialog" data-url="?c=adminUser&m=editUser&height=600&width=700&animate=false&is_ajax=1" data-title="添加用户" type="button">添加用户</button>
    	</div>
        <table class="table table-bordered" width="100%">
			...
			<tbody>
			<?php foreach ($list['list'] as $lt):?>
				<tr id="tr_<?=$lt['id']?>">
					<td><?=$lt['id']?></td>
					<td class="node" style="padding-left:10px;text-align:left"><?=$lt['username']?></td>
...
<script src="<?php echo $base_url;?>/assets/js/admin/app/adminMember.js"></script>
